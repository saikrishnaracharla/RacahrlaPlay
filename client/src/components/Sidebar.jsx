...
import { Home, Search, Music, ListMusic, Plus, Trash2, X, Library, ChevronRight } from 'lucide-react';
    ...
    <div style={{ display:'flex', flexDirection:'column', height:'100%' }}>
      ...
      <div style={{ flex:1, overflowY:'auto', padding:'0 10px' }}>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 6px', marginBottom:'10px' }}>
          ...
          <button onClick={() => setShowInput(v => !v)} style={{ background:'none', border:'none', cursor:'pointer', color:'rgba(255,255,255,0.4)', display:'flex', padding:'3px', borderRadius:'4px', transition:'color 0.2s' }}
        ...
        {showInput && (
          <div style={{ padding:'0 4px', marginBottom:'10px' }}>
            <input autoFocus value={name} onChange={e => setName(e.target.value)}
              ...
              style={{ width:'100%', background:'rgba(255,255,255,0.07)', border:'1.5px solid rgba(255,255,255,0.12)', borderRadius:'8px', padding:'8px 12px', color:'#fff', fontSize:'13px', fontFamily:'inherit', outline:'none', marginBottom:'6px' }}
